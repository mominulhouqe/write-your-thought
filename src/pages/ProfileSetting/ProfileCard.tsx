      ...
      <section className="max-w-3xl mx-auto p-4">
        ...
        >
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h5 className="text-lg font-bold">{userInfo?.name || "Admin"}</h5>
              <p className="text-gray-600">{userInfo?.role || "CEO/Co-Founder"}</p>
            </div>
          </div>
        ...
        >
          <div className="p-4">
            <h5 className="text-lg font-bold mb-4">Basic Info</h5>
            <div className="grid grid-cols-2 gap-4">
              <TextInput label="Name" id="name" value={userInfo?.name || ""} />
              <TextInput label="Email" id="email" value={userInfo?.email || ""} />
            </div>
            <SaveButton text="Save Changes" />
          </div>
        </motion.div>
        ...
        >
          <div className="p-4">
            ...
            <div className="space-y-4">
              <TextInput label="Current Password" id="currentPass" type="password" />
              <TextInput label="New Password" id="newPass" type="password" />
              <TextInput label="Confirm New Password" id="confirmPass" type="password" />
            </div>
            <SaveButton text="Update Password" />
          </div>
        </motion.div>
